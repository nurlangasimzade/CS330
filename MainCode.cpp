...
#include "ShapeMeshes.h" // Assuming ShapeMeshes.h exists and is needed
#include "ShaderManager.h" // Assuming ShaderManager.h exists and is needed
#include "sw_version.h" // Assuming sw_version.h exists and is needed
...
int main(int argc, char* argv[])
{
	...
	printSofwareVersion(); // Assuming printSofwareVersion() is defined in sw_version.h/cpp
	...
	g_ShaderManager->LoadShaders(
		"shaders/vertexShader.glsl", // Ensure these shader files exist
		"shaders/fragmentShader.glsl"); // Ensure these shader files exist
	g_ShaderManager->use();
